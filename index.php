    ...
    <form action="login.php" method="post">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" placeholder="Barberia" value="1" name="barber"  required="required" />
                </div>
            </div>
            <div class="forgot">
        ...
        <br/>
        <a href="usuario_cliente_agregar.php" class="btn btn-danger btn-print" style=" font-size: 20px; width:410px;"  role="button">Registrate</a>
    </div>
       <footer>

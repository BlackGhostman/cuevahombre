...
?>
 ...
 <!--end of modal-->
              ...
              <a class="btn btn-warning btn-print" href="servicio.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
...
?>
        ...
        <form class="form-horizontal" method="post" action="servicio_actualizar.php" enctype='multipart/form-data'>

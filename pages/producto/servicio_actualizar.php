...
$target_dir = "subir_producto/";
	...
	mysqli_query($con,"update producto set nombre_pro='$nombre_pro',imagen='$img',descripcion='$descripcion',precio_compra='$precio_compra' where id_pro='$id_pro'")or die(mysqli_error());

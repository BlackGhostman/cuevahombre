...
?>
  ...
  echo '<script language="javascript">alert("' . $_POST['username'] . '"); return false;</script>';
...
<ul id="myUL">
    <?php
                ...
                from producto where  stock>0 and estado in('a','d') ")or die(mysqli_error());
                    $i=1;
                    while($row=mysqli_fetch_array($query)){
                    $id_pro=$row['id_pro'];
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 btn-print">
                            <div class="form-group">
                                ...
                                <input  class="form-control" id="cantidad" name="cantidad" type="number"  min="0" max="<?php echo $row['stock_actual']; ?>" id="cantidad" placeholder="cantidad" style="width: : 100%;" onkeypress='return event.charCode >= 48 && event.charCode <= 57' autocomplete="off" required>
                            </div>

...
?>
            ...
            <?php echo ($num > 0) ? '<a href="../reserva/reserva.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
...
?>
            ...
            <?php echo ($num > 0) ? '<a href="../reserva/reservas_usuario.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
...
?>
            ...
            <div class="icon"><img height="80" width="80" src="img/agregar.png">
              <i class=""></i>
            </div>
            <?php echo ($num > 0) ? '<a href="../reserva/reserva.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
...
?>
            ...
            <?php echo ($num > 0) ? '<a href="../cliente/clientes.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
    <?php
                      }
...
?>
            ...
            <?php echo ($num > 0) ? '<a href="../ingresos/ingresos.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
                <h4>
                  <?php
                  $num=0;
                      $query=mysqli_query($con,"select * from producto where estado='d'")or die(mysqli_error());
                      $i=0;
                      while($row=mysqli_fetch_array($query)){
                      $num++;
                    }
            ...
            <div class="icon"><img height="80" width="80" src="img/servicios.png">
              <i class=""></i>
            </div>
            <?php echo ($num > 0) ? '<a href="../producto/servicio.php" class="small-box-footer">Mas info<i class="fa fa-arrow-circle-right"></i></a>' : '<a href="#" class="small-box-footer">-------</a>'; ?>
          </div>
        </div>
